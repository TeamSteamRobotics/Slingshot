...
public class Actuator extends Command {
	...
	protected void execute() {
		target = Robot.oi.stick.getThrottle();
		position = Robot.actuatorSubsystem.getPosition();
		
		Robot.actuatorSubsystem.move(target - position);
	}
	...
	@Override
	protected void end() {
		Robot.actuatorSubsystem.move(0);
	}
